...
function get(obj) {
   var poststr = "apikey=" + encodeURIComponent( document.getElementById("apikey").value ) +
		"&comment=" + encodeURIComponent( document.getElementById("comment").value ) +
		"&type=" + encodeURIComponent( document.getElementById("keytype").value);
   makePOSTRequest('/apikeys/postkey.php', poststr);
}
