...
class BulkCnst
{
    ...
    const TPL_CHECKBOX_ITEM = '<div class="custom-checkbox"><label for="sel[%id%]">&nbsp;&nbsp;<input type="checkbox" name="sel[%id%]" id="sel[%id%]" value="1"%attr%>&nbsp;&nbsp;<span class="label-text"></span>%label%</label></div>';
