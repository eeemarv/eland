...
{
  #[Route(
    '/{schema}/{role_short}/contacts/{id}/edit',
    name: 'contacts_edit',
    methods: ['GET', 'POST'],
    requirements: [
      'id'            => '%assert.id%',
  ...
  #[Route(
    '/{schema}/{role_short}/users/{user_id}/contacts/{contact_id}/edit',
  ...
  #[Route(
    '/{schema}/{role_short}/users/contacts/{contact_id}/edit',
