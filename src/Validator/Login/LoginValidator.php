...
class LoginValidator extends ConstraintValidator
{
  public function __construct(
    ...
    private readonly string $env_master_password
  )
  {
  }
  ...
  public function validate($command, Constraint $constraint):void
  {
    ...
    if (!isset($command->id))
    {
      $count_by_name = $this->user_repository->count_active_by_name(
    ...
    if (!isset($command->id))
    {
      $count_by_code = $this->user_repository->count_active_by_code(
