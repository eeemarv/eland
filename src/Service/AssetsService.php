...
class AssetsService
{
	...
	const ASSETS_ARY = [
		...
		'leaflet'	=> [
			'js'	=> [
				'leaflet/1.8.0/leaflet.js',
			],
			'css'	=> [
				'leaflet/1.8.0/leaflet.css',
			]
		],
		'summernote' => [
			'js'	=> [
		...
		'codemirror' => [
			'js'	=> [
				'codemirror/5.65.3/codemirror.min.js',
				'codemirror/5.65.3/addon/dialog/dialog.min.js',
				'codemirror/5.65.3/mode/xml/xml.min.js',
				'codemirror/5.65.3/mode/css/css.min.js',
				'codemirror/5.65.3/mode/javascript/javascript.min.js',
				'codemirror/5.65.3/mode/htmlmixed/htmlmixed.min.js ',
				'codemirror/5.65.3/addon/fold/xml-fold.min.js',
				'codemirror/5.65.3/addon/hint/xml-hint.min.js',
				'codemirror/5.65.3/addon/selection/active-line.min.js',
				'codemirror/5.65.3/addon/search/searchcursor.min.js',
				'codemirror/5.65.3/addon/search/jump-to-line.min.js',
				'codemirror/5.65.3/addon/search/search.min.js',
				'codemirror/5.65.3/addon/edit/matchbrackets.min.js',
				'codemirror/5.65.3/addon/edit/closebrackets.min.js',
				'codemirror/5.65.3/addon/edit/matchtags.min.js',
				'codemirror/5.65.3/addon/edit/closetag.min.js',
				'codemirror/5.65.3/addon/edit/trailingspace.min.js',
			],
			'css'	=> [
				'codemirror/5.65.3/codemirror.min.css',
				'codemirror/5.65.3/theme/monokai.min.css',
				'codemirror/5.65.3/addon/dialog/dialog.min.css',
			],
		],
		'sortable' => [
			'js'	=> [
