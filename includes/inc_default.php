...
$cdn_jqueryui_i18n = (getenv('ELAS_CDN_JQUERYUI_I18N')) ?: '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/i18n/jquery-ui-i18n.min.js';
$cdn_jqueryui_css = (getenv('ELAS_CDN_JQUERYUI_CSS')) ?: '//code.jquery.com/ui/1.11.4/themes/black-tie/jquery-ui.css';
$cdn_typeahead = (getenv('ELAS_CDN_TYPEAHEAD')) ?: '//cdnjs.cloudflare.com/ajax/libs/typeahead.js/0.10.4/typeahead.bundle.min.js';
$cdn_datepicker_css = (getenv('ELAS_CDN_DATEPICKER_CSS')) ?: '//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.4.0/css/bootstrap-datepicker3.standalone.min.css';
